...
# ------------------------------------------------------------
def compare_all_cifar100(epochs=30):
    ...
    plot_metric(0, "CIFAR-100: Train Accuracy", "Accuracy (%)")
    plot_metric(1, "CIFAR-100: Test Accuracy",  "Accuracy (%)")
    plot_metric(2, "CIFAR-100: Train Loss",     "Loss")
    plot_metric(3, "CIFAR-100: Test Loss",      "Loss")
    ...
    plt.xticks(x, names)
    #plt.title("CIFAR-100: Precision / Recall / F1")
    plt.legend()
    plt.show()
...
if __name__ == "__main__":
    compare_all_cifar100(epochs=30)