...
# TRAINING LOOP
# ------------------------------------------------------------
def train_model(name, opt_fn, epochs=80):
...
# ------------------------------------------------------------
def compare_all_cifar10(epochs=80):
    ...
    plot_metric(0, "CIFAR-10: Train Accuracy", "Accuracy (%)")
    plot_metric(1, "CIFAR-10: Test Accuracy",  "Accuracy (%)")
    plot_metric(2, "CIFAR-10: Train Loss",     "Loss")
    plot_metric(3, "CIFAR-10: Test Loss",      "Loss")
    ...
    plt.xticks(x, names)
    # plt.title("CIFAR-10: Precision / Recall / F1")
    plt.legend()
    plt.show()
